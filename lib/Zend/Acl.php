...
if (!defined('ACL_ROOT')) {
    define('ACL_ROOT', dirname(__FILE__) . '/');
}

/**
 * @see Zend_Acl_Resource_Interface
 */
require_once ACL_ROOT.'Acl/Resource/Interface.php';


/**
 * @see Zend_Acl_Role_Registry
 */
require_once ACL_ROOT.'Acl/Role/Registry.php';


/**
 * @see Zend_Acl_Assert_Interface
 */
require_once ACL_ROOT.'Acl/Assert/Interface.php';


/**
 * @see Zend_Acl_Role
 */
require_once ACL_ROOT.'Acl/Role.php';


/**
 * @see Zend_Acl_Resource
 */
require_once ACL_ROOT.'Acl/Resource.php';
