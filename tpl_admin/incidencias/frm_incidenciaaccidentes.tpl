		...
		<section class="scrollable padder">
			<div class="m-b-md">
            	<h3 class="m-b-none">
            		...
            		Añadir incidencia de accidente
			...
			<section class="panel panel-default">
                ...
                <div class="panel-body">
                  <form enctype="multipart/form-data" method="post" action="/admin/guardar-incidencia/accidentes/" class="form-horizontal" data-validate="parsley">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        <input value="{$incidencia->fecha_fin_incidencia}" data-date-format="dd/mm/yyyy" name="fecha_permiso" class="input-sm input-s datepicker-input form-control" type="text"  >
                      </div>
                    </div>
                    <div class="line line-dashed b-b line-lg pull-in"></div>
                    <div class="form-group">
