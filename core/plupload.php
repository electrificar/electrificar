...
<ul class="tabs">
    <li><a href="#tab1">{lang text="Imagenes"}</a></li>
    <li><a href="#tab2">{lang text="Cargar Imagenes"}</a></li>
</ul>
<div class="tab_container">
    ...
    <div id="tab2" class="tab_content">
    	<input type="hidden" id="upload_archivos" name="upload_archivos" value="">
		<div id="uploader">You browser doesn't support simple upload forms. Are you using Lynx?</div>
	</div>
</div>
